...
;
;	Module compile time: Fri May 16 17:04:28 2025
...
._mapa
	...
	defm	"vwwwwwwvwwwwwwvwwwwwwwwgwwwwww"
	defm	"gvwwwwwgfwwwwwzwwwwwww"
	defb	0
...
;	SECTION	code
	...
	._motor_lut
	defw 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000
	defw 0x0000, 0x0006, 0x000C, 0x000F, 0x0011, 0x000F, 0x000C, 0x0006, 0x0000, 0xFFF9, 0xFFF3, 0xFFF0, 0xFFEF, 0xFFF0, 0xFFF3, 0xFFF9
	defw 0x0000, 0x000D, 0x0018, 0x001F, 0x0022, 0x001F, 0x0018, 0x000D, 0x0000, 0xFFF2, 0xFFE7, 0xFFE0, 0xFFDE, 0xFFE0, 0xFFE7, 0xFFF2
	defw 0x0000, 0x0013, 0x0024, 0x002F, 0x0033, 0x002F, 0x0024, 0x0013, 0x0000, 0xFFEC, 0xFFDB, 0xFFD0, 0xFFCD, 0xFFD0, 0xFFDB, 0xFFEC
	defw 0x0000, 0x001A, 0x0030, 0x003E, 0x0044, 0x003E, 0x0030, 0x001A, 0x0000, 0xFFE5, 0xFFCF, 0xFFC1, 0xFFBC, 0xFFC1, 0xFFCF, 0xFFE5
	defw 0x0000, 0x0020, 0x003C, 0x004E, 0x0055, 0x004E, 0x003C, 0x0020, 0x0000, 0xFFDF, 0xFFC3, 0xFFB1, 0xFFAB, 0xFFB1, 0xFFC3, 0xFFDF
	defw 0x0000, 0x0027, 0x0048, 0x005E, 0x0066, 0x005E, 0x0048, 0x0027, 0x0000, 0xFFD8, 0xFFB7, 0xFFA1, 0xFF9A, 0xFFA1, 0xFFB7, 0xFFD8
	defw 0x0000, 0x002D, 0x0054, 0x006D, 0x0077, 0x006D, 0x0054, 0x002D, 0x0000, 0xFFD2, 0xFFAB, 0xFF92, 0xFF89, 0xFF92, 0xFFAB, 0xFFD2
	defw 0x0000, 0x0034, 0x0060, 0x007E, 0x0089, 0x007E, 0x0060, 0x0034, 0x0000, 0xFFCB, 0xFF9F, 0xFF81, 0xFF77, 0xFF81, 0xFF9F, 0xFFCB
	defw 0x0000, 0x003A, 0x006C, 0x008E, 0x009A, 0x008E, 0x006C, 0x003A, 0x0000, 0xFFC5, 0xFF93, 0xFF71, 0xFF66, 0xFF71, 0xFF93, 0xFFC5
	defw 0x0000, 0x0041, 0x0078, 0x009D, 0x00AB, 0x009D, 0x0078, 0x0041, 0x0000, 0xFFBE, 0xFF87, 0xFF62, 0xFF55, 0xFF62, 0xFF87, 0xFFBE
	defw 0x0000, 0x0047, 0x0084, 0x00AD, 0x00BC, 0x00AD, 0x0084, 0x0047, 0x0000, 0xFFB8, 0xFF7B, 0xFF52, 0xFF44, 0xFF52, 0xFF7B, 0xFFB8
	defw 0x0000, 0x004E, 0x0090, 0x00BD, 0x00CD, 0x00BD, 0x0090, 0x004E, 0x0000, 0xFFB1, 0xFF6F, 0xFF42, 0xFF33, 0xFF42, 0xFF6F, 0xFFB1
	defw 0x0000, 0x0054, 0x009C, 0x00CD, 0x00DE, 0x00CD, 0x009C, 0x0054, 0x0000, 0xFFAB, 0xFF63, 0xFF32, 0xFF22, 0xFF32, 0xFF63, 0xFFAB
	defw 0x0000, 0x005B, 0x00A8, 0x00DC, 0x00EF, 0x00DC, 0x00A8, 0x005B, 0x0000, 0xFFA4, 0xFF57, 0xFF23, 0xFF11, 0xFF23, 0xFF57, 0xFFA4
	defw 0x0000, 0x0061, 0x00B5, 0x00EC, 0x0100, 0x00EC, 0x00B5, 0x0061, 0x0000, 0xFF9E, 0xFF4A, 0xFF13, 0xFF00, 0xFF13, 0xFF4A, 0xFF9E

._cocher_get_lut_indexes
	ld	a,#(2 % 256 % 256)
	ld	(_cocher_friction),a
	ld	a,#(8 % 256 % 256)
	ld	(_cocher_vinc),a
	ld	a,#(240 % 256 % 256)
	ld	(_cocher_vmax),a
...
._player_custom_veng
	call	_cocher_get_lut_indexes
	call	_cocher_vertical
	ret



._player_custom_heng
	call	_cocher_horizontal
	ret
...
; --- Start of Scope Defns ---
	...
	XDEF	_u_free
	XDEF	_abs
	XDEF	_cocher_vertical
	XDEF	_s_ending
	LIB	sp_CharRight
	XDEF	_game_ending
	XDEF	_pvy_total
	LIB	sp_InstallISR
	XDEF	_cocher_horizontal
