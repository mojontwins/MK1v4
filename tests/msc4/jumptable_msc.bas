writeAssemblyString fOut, "; Existing entry point (indexed mode) still acts as|; the entry point for general scripts.|._script_do|ld  a, (_script_n)|cp  ENTERING_INDEX_OFFSET ; Fill with the right value!|jr  nc, get_from_jump_table"
