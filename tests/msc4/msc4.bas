...
If AU(&H6D) Then writeAssemblyString fOut, ";; OPCODE 0x6D|;; WARP TO N, X, Y|cp  0x6D|jr  nz, aopcode_6D_end|.aopcode_6D|call read_vbyte|ld  (_n_pant), a|call read_vbyte|sla a|sla a|sla a|sla a|ld  (_gpx), a|call read_vbyte|sla a|sla a|sla a|sla a|ld  (_gpy), a|.aopcode_6D_end"
