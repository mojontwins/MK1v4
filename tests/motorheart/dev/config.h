...
#define SCR_FIN					29		// Pantalla del final. 99 si da igual.
#define PLAYER_FIN_X			0		//
#define PLAYER_FIN_Y			8		// Posición del jugador para terminar, a nivel de tiles
#define PLAYER_NUM_OBJETOS		10		// Número de objetos para terminar el juego
...
#define VIEWPORT_X				1		//
#define VIEWPORT_Y				3		// Posición de la ventana de juego (en carácteres)
#define LIFE_X					5		//
#define LIFE_Y					1		// Posición del marcador de vida (en carácteres)
#define OBJECTS_X				16		//
#define OBJECTS_Y				1		// Posición del marcador de objetos (en carácteres)
#define KEYS_X					28		//
#define KEYS_Y					1		// Posición del marcador de llaves (en carácteres)
#define KILLED_X				16		//
#define KILLED_Y				1		// Posición del marcador de enemigos matados (en carácteres)
...
#define PLAYER_MAX_VX			320		// Velocidad máxima horizontal (192/64 = 3 píxels/frame)
...
unsigned char comportamiento_tiles [] = {
	0, 0, 0, 0, 0, 2, 2, 2, 0, 2, 1, 0, 1, 1, 2, 2
};
