...
#define PLAYER_LIFE 			100		// Max and starting life gauge.
#define PLAYER_REFILL			25		// Life recharge

#define LINEAR_ENEMY_HIT		10		// Amount of life to substract when normal enemy hits
#define FLYING_ENEMY_HIT		25		// Amount of life to substract when flying enemy hits
...
#define ITEM_IN_FLAG			5		// Which flag is used to store current item.
#define ITEM_FIRST_TILE			21		// First tile in tileset representing an object
#define ITEM_SHOW_X				0		//
#define ITEM_SHOW_Y				14		// Position
