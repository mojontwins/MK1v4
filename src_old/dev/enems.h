...
MALOTE malotes [] = {
	// Pantalla 0
 	...
 	{208, 16, 96, 16, 208, 16, -2, 0, 1},
 	{192, 0, 112, 0, 192, 0, -2, 0, 1},
	...
	// Pantalla 2
 	...
 	{144, 96, 144, 0, 144, 96, 0, -1, 3},
 	{176, 0, 176, 0, 176, 80, 0, 1, 2},

	// Pantalla 3
 	{96, 112, 48, 112, 96, 112, -1, 0, 3},
	...
	// Pantalla 11
 	...
 	{48, 112, 48, 64, 48, 112, 0, -1, 4},
 	{80, 48, 80, 48, 160, 96, 2, 2, 2},

	// Pantalla 12
 	{208, 112, 128, 112, 208, 112, -1, 0, 3},
 	{208, 80, 208, 16, 208, 80, 0, -1, 2},
 	{16, 16, 16, 16, 96, 128, 4, 4, 3},

	// Pantalla 13
 	{64, 0, 64, 0, 112, 48, 2, 2, 1},
 	{16, 64, 16, 64, 80, 112, 1, 1, 2},
 	{208, 16, 192, 16, 208, 128, -2, 2, 3},

	// Pantalla 14
 	{16, 0, 16, 0, 112, 32, 1, 1, 2},
 	{208, 0, 176, 0, 208, 48, -2, 2, 3},
 	{64, 64, 64, 0, 96, 64, 1, -1, 1},

	// Pantalla 15
 	{160, 112, 160, 64, 160, 112, 0, -1, 4},
 	{192, 32, 48, 32, 192, 32, -1, 0, 4},
 	{64, 0, 64, 0, 176, 16, 1, 1, 3},

	// Pantalla 16
 	{192, 48, 80, 48, 192, 48, -1, 0, 4},
 	{112, 32, 112, 32, 176, 32, 1, 0, 3},
 	{64, 80, 64, 80, 192, 112, 2, 2, 2},

	// Pantalla 17
 	{192, 48, 32, 48, 192, 48, -1, 0, 4},
 	{16, 32, 16, 32, 128, 32, 1, 0, 1},
 	{16, 64, 16, 64, 112, 112, 2, 2, 2},

	// Pantalla 18
 	{208, 64, 128, 64, 208, 64, -1, 0, 2},
	...
	// Pantalla 20
 	{176, 48, 32, 48, 176, 48, -1, 0, 1},
 	{176, 64, 48, 64, 176, 64, -1, 0, 1},
 	{16, 0, 16, 0, 192, 32, 2, 2, 2},

	// Pantalla 21
 	{32, 112, 32, 112, 192, 112, 2, 0, 4},
 	{192, 32, 48, 32, 192, 32, -2, 0, 4},
 	{176, 80, 48, 80, 176, 80, -1, 0, 1},

	// Pantalla 22
 	{208, 80, 32, 80, 208, 80, -1, 0, 4},
 	{64, 64, 64, 64, 176, 64, 1, 0, 2},
 	{16, 0, 0, 0, 16, 144, -3, 3, 2},

	// Pantalla 23
 	{16, 48, 16, 48, 208, 48, 1, 0, 4},
 	{96, 64, 96, 64, 96, 128, 0, 1, 1},
 	{208, 80, 128, 80, 208, 128, -2, 2, 3},

	// Pantalla 24
 	{96, 32, 96, 32, 96, 96, 0, 2, 1},
 	{128, 80, 128, 80, 224, 80, 2, 0, 4},
 	{96, 112, 16, 112, 96, 112, -1, 0, 3},

	// Pantalla 25
 	{112, 16, 112, 16, 112, 80, 0, 1, 2},
 	{48, 96, 48, 0, 48, 96, 0, -2, 1},
 	{176, 48, 176, 48, 176, 128, 0, 2, 3},

	// Pantalla 26
 	{160, 32, 160, 32, 192, 80, 2, 2, 1},
 	{96, 48, 96, 0, 96, 48, 0, -1, 2},
 	{144, 144, 48, 144, 144, 144, -1, 0, 3},

	// Pantalla 27
 	{32, 80, 32, 16, 32, 80, 0, -2, 1},
 	{192, 80, 192, 32, 192, 80, 0, -2, 2},
 	{112, 80, 112, 32, 112, 80, 0, -1, 3},

	// Pantalla 28
 	{208, 48, 32, 48, 208, 48, -1, 0, 4},
 	{64, 32, 64, 32, 192, 32, 1, 0, 2},
 	{80, 96, 80, 96, 112, 96, 1, 0, 1},

	// Pantalla 29
 	{112, 16, 16, 16, 112, 80, -2, 2, 3},
