...
#define FLYING_ENEMY_HIT			7		// Amount of life to substract when flying enemy hits
...
#define MAX_FLAGS					21		// Number of flags. For scripting and stuff.
...
#define ENEMIES_COLLIDE_MASK 		8 		// Bitwise. Default is 9, beware!
