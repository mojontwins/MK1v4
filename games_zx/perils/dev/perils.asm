...
;
;	Module compile time: Mon Nov 27 11:24:04 2023
...
._get_cell_n
	ld	hl,_level_linear_enem_cells
	push	hl
	ld	a,(_level)
	ld	e,a
	ld	d,0
...
; --- Start of Scope Defns ---
	...
	XDEF	_extra_sprite_24_a
	XDEF	_extra_sprite_24_b
	XDEF	_sprite_17_a
	XDEF	_sprite_18_a
	XDEF	_qtile
	XDEF	_sp_player
