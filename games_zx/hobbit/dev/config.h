...
#define COMPRESSED_TS 					// TS will contain 0s, and tilesetc.bin is used
...
#define PLAYER_MAY_BE_INVISIBLE				// Only chase if player.invisible == 0
...
#define PLAYER_CONST_V				128		// Constant speed
...
#define MAX_ANIMATED_TILES 			4 		// Must be a power of two
