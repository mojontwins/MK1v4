...
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp8x16TileMap2bGPxP(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp8x24TileMap2bGPxP(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp16x16TileMap2bPxM1(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp16x16TileMap2bGPxM1(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp16x16TileMap2bGPxM1P(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp16x24TileMap2bGPxM1P(int sprite);
