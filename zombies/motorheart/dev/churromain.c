// churromain.c
// Esqueleto de juegos de la churrera 3.0
...
void main (void) {
	...
	for (i = 0; i < 3; i ++) {
		sp_moviles [i] = sp_CreateSpr(sp_MASK_SPRITE, 3, sprite_9_a, 2);
		sp_AddColSpr (sp_moviles [i], sprite_9_b);
		sp_AddColSpr (sp_moviles [i], sprite_9_c);	
