...
;Pautas (instrumentos)
;Instrumento 'Piano'
PAUTA_0:	DB	45,0,12,0,10,0,7,0,4,0,129
;Instrumento 'PICC'
PAUTA_1:	DB	74,0,4,0,6,0,9,0,7,0,5,0,9,0,6,0,1,0,129
;Instrumento 'Flauta vol bajo'
PAUTA_2:	DB	12,0,9,0,7,0,9,0,11,0,9,0,10,0,10,0,8,0,10,0,129
;Instrumento 'Flauta'
PAUTA_3:	DB	8,0,10,0,11,0,11,0,11,0,10,0,9,0,8,0,9,0,8,0,8,0,8,0,8,0,8,0,8,0,7,0,7,0,7,0,7,0,138
;Instrumento 'Picc vol 2'
PAUTA_4:	DB	71,0,6,0,7,0,6,0,5,0,129
;Instrumento 'Eco'
PAUTA_5:	DB	3,0,7,0,9,0,6,0,7,0,6,0,129
