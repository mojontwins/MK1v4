...
MALOTE malotes [] = {
	...
	// Pantalla 1
 	...
 	{96, 48, 96, 48, 96, 64, 0, 0, 13},

	// Pantalla 2
 	{128, 16, 128, 16, 192, 16, 1, 0, 1},
 	{128, 80, 128, 80, 128, 128, 0, 1, 2},
 	{32, 48, 32, 48, 32, 128, 0, 1, 3},

	// Pantalla 3
 	{32, 96, 32, 96, 48, 128, 2, 2, 14},
 	{176, 48, 48, 48, 176, 48, -2, 0, 2},
 	{192, 128, 112, 128, 192, 128, -1, 0, 4},
	...
	// Pantalla 5
 	{96, 64, 96, 16, 96, 64, 0, -2, 14},
 	{128, 16, 128, 16, 128, 112, 0, 2, 13},
 	{16, 112, 16, 112, 112, 112, 2, 0, 12},
	...
	// Pantalla 8
 	{176, 48, 48, 48, 176, 48, -1, 0, 2},
 	{64, 16, 64, 16, 176, 16, 1, 0, 1},
 	{176, 80, 32, 80, 176, 96, -1, 1, 3},

	// Pantalla 9
 	{128, 96, 128, 32, 128, 96, 0, -2, 2},
 	{96, 48, 16, 48, 96, 48, -1, 0, 4},
 	{16, 16, 16, 16, 96, 16, 1, 0, 2},

	// Pantalla 10
 	{208, 48, 64, 48, 208, 48, -1, 0, 11},
 	{16, 96, 16, 96, 192, 96, 2, 0, 12},
 	{16, 16, 16, 16, 32, 16, 0, 0, 3},

	// Pantalla 11
 	{32, 16, 32, 16, 192, 128, 2, 2, 3},
 	{160, 16, 16, 16, 160, 96, -1, 1, 1},
 	{208, 48, 192, 48, 208, 48, -2, 0, 14},

	// Pantalla 12
 	{32, 32, 32, 32, 64, 96, 1, 1, 1},
 	{64, 16, 64, 16, 160, 32, 1, 1, 2},
 	{192, 48, 160, 48, 192, 112, -1, 1, 3},

	// Pantalla 13
 	{48, 16, 48, 16, 160, 16, 2, 0, 1},
 	{176, 128, 32, 128, 176, 128, -1, 0, 4},
 	{192, 64, 192, 48, 192, 64, 0, -1, 12},
	...
	// Pantalla 15
 	{16, 32, 16, 32, 16, 112, 0, 2, 11},
 	{112, 16, 112, 16, 112, 96, 0, 1, 2},
 	{160, 48, 160, 48, 160, 112, 0, 2, 14},
	...
	// Pantalla 20
 	{16, 64, 16, 64, 32, 64, 2, 0, 13},
 	{96, 96, 96, 96, 112, 96, 2, 0, 11},
...
#define N_ENEMS_TYPE_11 4
#define N_ENEMS_TYPE_12 3
