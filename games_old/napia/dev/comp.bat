...
..\utils\mkts_om.exe platform=cpc mode=palsasassembly in=..\gfx\%om%\pal0.png prefix=inks0 out=%om%\pal0.h silent > nul
..\utils\mkts_om.exe platform=cpc mode=palsasassembly in=..\gfx\%om%\pal1.png prefix=inks1 out=%om%\pal1.h silent > nul
..\utils\mkts_om.exe platform=cpc mode=palsasassembly in=..\gfx\%om%\pal2.png prefix=inks2 out=%om%\pal2.h silent > nul
..\utils\mkts_om.exe platform=cpc mode=palsasassembly in=..\gfx\%om%\pal3.png prefix=inks3 out=%om%\pal3.h silent > nul
