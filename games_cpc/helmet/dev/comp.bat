...
zcc +cpc -m -vn -unsigned -zorg=1024 -lcpcrslib_fg -o %game%.bin system\tilemap_conf.asm churromain.c -DDEMO > nul
zcc +cpc -a -vn -unsigned -zorg=1024 -lcpcrslib_fg -o %game%.asm system\tilemap_conf.asm churromain.c -DDEMO > nul
