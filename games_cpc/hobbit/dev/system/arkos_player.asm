...
; Ported to z88dk by Fido, el mono jodido
...
.PLY_Track1_InstrumentsTablePT ld bc,0
	...
	;jr z,$+5
	jr z, PLY_Track1_SMC_dst_A
	ld (PLY_PSGReg13_Retrig + 1),a
.PLY_Track1_SMC_dst_A
	inc hl
...
.PLY_Track2_InstrumentsTablePT ld bc,0
	...
	or a				;Get IsRetrig?. Code it only if different to 0, else next Instruments are going to overwrite it.
	;jr z,$+5
	jr  z, PLY_Track2_SMC_dst_A
	ld (PLY_PSGReg13_Retrig + 1),a
.PLY_Track2_SMC_dst_A	
	inc hl
...
.PLY_Track3_InstrumentsTablePT 
	...
	or a				;Get IsRetrig?. Code it only if different to 0, else next Instruments are going to overwrite it.
	;jr z,$+5
	jr  z, PLY_Track3_SMC_dst_A
	ld (PLY_PSGReg13_Retrig + 1),a
.PLY_Track3_SMC_dst_A
	inc hl
...
.PLY_PS_S_SoundOn
	...
	sub d						;Code Volume.
	;jr nc,$+3
	jr nc, PLY_PS_S_SoundOn_smc_A
	xor a
.PLY_PS_S_SoundOn_smc_A
	ld (iy + 7),a
...
.PLY_PS_S_SBN_NoNoise
	...
	sub d						;Code Volume.
	;jr nc,$+3
	jr nc, PLY_PS_S_SBN_NoNoise_smc_A
	xor a
.PLY_PS_S_SBN_NoNoise_smc_A	
	ld (iy + 7),a
...
.PLY_PS_SD_Shift_dst
	...
	rr l
	;jr nc,$+3
	jr PLY_PS_SD_Shift_NCplus3_dst
	inc hl
.PLY_PS_SD_Shift_NCplus3_dst
	;Hardware Pitch ?
	bit 7-2,a
...
.PLY_PS_HD_Shift 
	;jr $+2
	jr PLY_PS_HD_Shift_smc_dst
.PLY_PS_HD_Shift_smc_dst
	sla l
	rl h
	sla l
	rl h
...
defc PLY_SFX_OffsetVolume = PLY_SFX_Track1_smc_entry+2 - PLY_SFX_Track1_Pitch
defc PLY_SFX_OffsetNote = PLY_SFX_Track1_smc_entry+1 - PLY_SFX_Track1_Pitch
