...
Sub usage 
	Print "usage:"
	Print ""
	Print "rle44map_sp.exe in=map.map out=map.bin size=W,H [tlock=T] [mk1locks]"
...
Print "rle44map_sp v0.2.20200214 ~ ";
...
If sclpGetValue ("mk1h") <> "" Then
	...
	Print #fOut, "// Mapa.h "
	Print #fOut, "// Generated by rle44map_sp v0.2.20200214"
