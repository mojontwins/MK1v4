...
// Adapted to z88dk by na_th_an

#define PLY_UseSoundEffects				// Set if you want to use Sound Effects in your player. Both CPU and memory consuming.
#define PLY_RetrigValue		0xfe 		// Value used to trigger the Retrig of Register 13. #FE corresponds to CP xx. Do not change it !
...
#asm 
	...
	.PLY_Digidrum 
		defb 0							// Read here to know if a Digidrum has been played (0=no).
	...
	.PLY_track3_Volume_Note
		defc PLY_Track3_Volume = ASMPC+2
		defc PLY_Track3_Note = ASMPC+1
	...
	// ***************************************
	// Play Sound Effects on Track 3 (only assembled used #ifdef PLY_UseSoundEffects is set to one)
	// ***************************************
		...
		defc PLY_SFX_Track3_Volume = ASMPC+2
		defc PLY_SFX_Track3_Note = ASMPC+1
	...
	defc PLY_Track2_Volume = ASMPC+2
	defc PLY_Track2_Note = ASMPC+1
	...
	// ***************************************
	// Play Sound Effects on Track 2 (only assembled used #ifdef PLY_UseSoundEffects is set to one)
	// ***************************************
	#ifdef PLY_UseSoundEffects
		...
		defc PLY_SFX_Track2_Volume = ASMPC+2
		defc PLY_SFX_Track2_Note = ASMPC+1
	...
	defc PLY_Track1_Volume = ASMPC+2
	defc PLY_Track1_Note = ASMPC+1
		ld de,0							// D=Inverted Volume E=Note
	...
	// ***************************************
	// Play Sound Effects on Track 1 (only assembled used #ifdef PLY_UseSoundEffects is set to one)
	// ***************************************
	#ifdef PLY_UseSoundEffects
		...
		defc PLY_SFX_Track1_Volume = ASMPC+2
		defc PLY_SFX_Track1_Note = ASMPC+1
	...
	.PLY_PS_S_SecondByteNeeded
		ld ixl,1000B	// By defaut, No Noise, Sound.
		...
		ld (PLY_PSGReg6),a
		ld ixl,0000B					// Open Noise Channel.
	...
	.PLY_PS_Hard_NoRetrig
		...
		ld ixl,1000B					// Sound is always On here (only Independence mode can switch it off).
		...
		and 1111B			// We don't care about the bit 7-4, but we have to clear them, else the waveform might be reset.
		ld (PLY_PSGReg13),a
	...
	.PLY_Stop
		...
		defc PLY_SFX_OffsetPitch = 		0
		defc PLY_SFX_OffsetVolume = 	PLY_SFX_Track1_Volume - PLY_SFX_Track1_Pitch
		defc PLY_SFX_OffsetNote = 		PLY_SFX_Track1_Note - PLY_SFX_Track1_Pitch
		defc PLY_SFX_OffsetInstrument =	PLY_SFX_Track1_Instrument - PLY_SFX_Track1_Pitch
		defc PLY_SFX_OffsetSpeed = 		PLY_SFX_Track1_InstrumentSpeed - PLY_SFX_Track1_Pitch
		defc PLY_SFX_OffsetSpeedCpt = 	PLY_SFX_Track1_InstrumentSpeedCpt - PLY_SFX_Track1_Pitch
