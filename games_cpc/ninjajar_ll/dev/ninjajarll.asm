...
;
;	Module compile time: Tue Mar 25 13:22:26 2025
...
._custom_map_pointer_calculator
	._draw_scr_get_scr_address
	ld hl, _maps
	call get_pointer_from_array
	push hl
	ld a, (_n_pant)
	call get_pointer_from_array_hijack
	pop de
	add hl, de
	ld (_gp_gen), hl
	ret
...
._draw_scr_background
	...
	ld (_rdy), a
	ld (_rdi), a
	call	_custom_map_pointer_calculator
	._draw_scr_rle
	._draw_scr_loop
	ld a, (_rdi)
	cp 150
...
._main
	...
	ld (ix + 6), a
	ld (ix + 7), a
	ld hl, cpc_PutSpTileMap8x8Px
	ld (ix + 13), h
	ld (ix + 12), l
	ld hl, cpc_PutTrSp8x8TileMap2bPx
	ld (ix + 15), h
	ld (ix + 14), l
	ld hl, _sprite_sword
	ld (ix + 1), h
...
.i_152
	...
	call	_custom_flick_screen_handler
