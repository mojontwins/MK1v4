...
#define TOTAL_SCREENS				20		// 
#define SCR_INICIO					1		// Initial screen
#define PLAYER_INI_X				(l_ini_x [level])		//
#define PLAYER_INI_Y				(l_ini_y [level])		// Initial tile coordinates
...
//#define SWORD_HIT_FRAME 			2		// Frame to render 0-3 (for side view) (if defined)
...
#define SWORD_W 					16 		// For horizontal, LOGICAL width of the sprite (introduced for Ninjajar LL CPC)
...
#define MAX_BREAKABLE_FRAMES 		4 		// N = frames to display this tile:
#define BREAKABLE_BREAKING_TILE 	31		// display this for N frames
