...
=======
..\utils\mkts_om.exe platform=cpc cpcmode=0 pal=..\gfx\pal.png mode=sprites in=..\gfx\sprites.png out=sprites.bin mappings=spriteset_mappings.h max=22 silent > nul
>>>>>>> 6d2e4cbf6cc2109ad29ef67e18dd8c300acd430b
