...
..\utils\mkts_om.exe platform=cpc cpcmode=0 pal=..\gfx\pal.png mode=sprites in=..\gfx\sprites.png out=sprites.bin mappings=spriteset_mappings.h max=23 pixelperfectm0 silent > nul
...
echo Making script
..\utils\msc.exe ..\script\script.spt msc.h 36 cpc flipflops shortsettile > nul 
